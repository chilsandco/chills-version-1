        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed uppercase tracking-widest font-medium">
              Home delivery rates are calculated based on transit coordinates and logistical zones (standard shipping starts at ₹80). Collect in Store (Self Pickup) is available free of charge.
            </p>
          </div>
        </section>

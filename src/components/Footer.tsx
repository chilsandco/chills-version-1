        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li><Link to="/customize" className="text-neutral-500 hover:text-white text-sm transition-colors uppercase tracking-widest">Custom Studio</Link></li>
              <li><Link to="/social-vault" className="text-neutral-500 hover:text-white text-sm transition-colors uppercase tracking-widest">Social Vault</Link></li>

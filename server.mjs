...
const WooCommerce = new (WooCommerceRestApi.default || WooCommerceRestApi)({
...
async function startServer() {
  ...
  const mapProduct = (wcProduct) => ({
    ...
    concept: wcProduct.attributes.find((a) => a.name.toLowerCase() === "concept")?.options[0] || "A precise exploration of form and function.",
    material: wcProduct.attributes.find((a) => a.name.toLowerCase() === "material")?.options[0] || "Premium technical fabric.",
    fit: wcProduct.attributes.find((a) => a.name.toLowerCase() === "fit")?.options[0] || "Regular fit.",
    care: wcProduct.attributes.find((a) => a.name.toLowerCase() === "care")?.options[0] || "Machine wash cold.",
